                ...
                <div class="offset-md-1 col-md-10">
                    <div class="card shadow">
                        <div class="card-header d-flex justify-content-center">
                            <h2 class="text-success my-3  text-center"> Edit PROPERTY</h2>
                        </div>
                        <div class="card-body">
                                ...
                                @endif
                            <form method="post" action="{{route('admin.editpropertyprocess')}}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-select" id="property_type" name="property_type" aria-label="Default select example">
                                            @foreach($property_type as $key => $property_type_val)
                                               <option value="{{$property_type_val}}" @if($property->property_type==$property_type_val) selected @endif >{{$property_type_val}}</option> 
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-12" @if($property->property_type=="Apartment") style="display:block" @else style="display:none" @endif id="apartment_type">
                                        ...
                                        <select class="form-select" name="sub_property_type" aria-label="Default select example">
                                            @foreach($apartment_type as $key => $apartment_type_val)
                                               <option value="{{$apartment_type_val}}" @if($property->sub_property_type==$apartment_type_val) selected @endif >{{$apartment_type_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-12" id="house_type" @if($property->property_type=="House") style="display:block" @else style="display:none" @endif>
                                        ...
                                        <select class="form-select"id="sub_property_type2" name="sub_property_type" aria-label="Default select example">
                                            @foreach($house_type as $key => $house_type_val)
                                               <option value="{{$house_type_val}}" @if($property->sub_property_type==$house_type_val) selected @endif >{{$house_type_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                            {{ $errors->first('sub_property_type') }}
                                    ...
                                    <div class="form-group col-md-12" id="room_type" @if($property->property_type=="Room") style="display:block" @else style="display:none" @endif>
                                        ...
                                        <select class="form-select" id="sub_property_type3" name="sub_property_type" aria-label="Default select example">
                                            @foreach($room_type as $key => $room_type_val)
                                               <option value="{{$room_type_val}}" @if($property->sub_property_type==$room_type_val) selected @endif >{{$room_type_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                            {{ $errors->first('sub_property_type') }}
                                    ...
                                    <div class="form-group col-md-10">
                                        <label for="parking-type"><i
                                            ...
                                            fas fa-parking"></i>
                                            Address</label>
                                        <input class="form-control" type="text" name="address" value="{{$property->address}}" id="location" tabindex="2"
                                            required />
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-2">
                                        <label for="parking-type"><i
                                            ...
                                            fas fa-parking"></i>
                                            Unit</label>
                                        <input class="form-control" type="text" name="unit" value="{{$property->unit}}" tabindex="2"
                                             />
                                        <span class="text-danger">
                                            {{ $errors->first('unit') }}
                                        </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="selectpicker form-control" name="untility_name[]" multiple
                                            ...
                                            @foreach($utility_include as $key => $utility_include_val)
                                               <option value="{{$utility_include_val}}"
                                               @if(!empty($property->utilityInclude))
                                                 @foreach($property->utilityInclude as $key => $utilityInclude_value)
                                                     @if($utilityInclude_value->name==$utility_include_val)
                                                      selected
                                                     @endif
                                                 @endforeach
                                               @endif
                                               >{{$utility_include_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="selectpicker form-control" name="category_name[]" multiple
                                            ...
                                            @foreach($category as $key => $category_val)
                                               <option value="{{$category_val}}"
                                               @if(!empty($property->category))
                                                 @foreach($property->category as $key => $category_value)
                                                     @if($category_value->name==$category_val)
                                                      selected
                                                     @endif
                                                 @endforeach
                                               @endif
                                        ...
                                        <label for="unit"><i class="fas fa-calendar"></i> Year</label>
                                         <select class="form-control form-select" name="year_build">
                                           <option value="" >Select year</option>
                                            @for($i = 1800; $i <= $year; $i++)
                                                <option value="{{$i}}" @if($property->year_build==$i) selected @endif>{{$i}}</option>
                                            @endfor
                                        </select>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control form-select" name="pet_friendly">
                                            ...
                                            @foreach($yes_no as $key => $yes_no_val)
                                               <option value="{{$yes_no_val}}" @if($property->pet_friendly==$yes_no_val) selected @endif>{{$yes_no_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                            {{ $errors->first('year') }}
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control form-select" name="furnished">
                                            ...
                                            @foreach($yes_no as $key => $yes_no_val)
                                               <option value="{{$yes_no_val}}" @if($property->furnished==$yes_no_val) selected @endif>{{$yes_no_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control form-select" name="short_term">
                                            ...
                                            @foreach($yes_no as $key => $yes_no_val)
                                               <option value="{{$yes_no_val}}" @if($property->short_term==$yes_no_val) selected @endif>{{$yes_no_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control form-select" name="lease_term" required>
                                            @foreach($lease_term as $key => $lease_term_val)
                                               <option value="{{$lease_term_val}}" @if($property->lease_term==$lease_term_val) selected @endif>{{$lease_term_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control form-select" name="parking_type">
                                           ...
                                           @foreach($parking_type as $key => $parking_type_val)
                                               <option value="{{$parking_type_val}}" @if($property->parking_type==$parking_type_val) selected @endif>{{$parking_type_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                    ...
                                    <div id="moreproduct" class="clonediv"> 
                                       @if(!empty($property->floor))
                                            @foreach($property->floor as $key => $floor_value)
                                                <div class="productdiv">
                                                    <div class="row">
                                                       <input type="hidden" name="floor_id[]" value="{{$floor_value->id}}">
                                                        <div class="form-group col-md-2">
                                                            <label for="bathrrom"><i
                                                                    class="
                                                                fas fa-bed"></i>
                                                                Bedrooms</label>
                                                            <input class="form-control" step="0.5" type="number" name="bedroom[]" value="{{$floor_value->bedroom}}" tabindex="2"
                                                                required />
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                            <label for="bath"><i
                                                                ...
                                                                fas fa-bath"></i>
                                                                Bath</label>
                                                            <input class="form-control" step="0.5" type="number" name="bathroom[]" value="{{$floor_value->bathroom}}" tabindex="2"
                                                                required />
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                            <label for="price"><i class="fas fa-money-bill-wave"></i> Price</label>
                                                            <input class="form-control" type="number" name="rent[]" value="{{$floor_value->rent}}" tabindex="2"
                                                                required />
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                            <label for="price"><i class="fas fa-calendar"></i> Available Date</label>
                                                            <input class="form-control" type="date" name="availability[]" value="{{$floor_value->availability}}" tabindex="2"
                                                                required />
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                            <label for="price">Unit Size</label>
                                                            <input type="text" class="form-control" name="unit_size[]" value="{{$floor_value->unit_size}}" id="">
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                            <div class="row mt-32 ">
                                                                <div class="col-md-6 ">
                                                                    <button type="button" class="btn  w-100 border text-success add-btn"
                                                                        title="Add">
                                                                ...
                                                                <div class="col-md-6 text-center ">
                                                                    <button type="button" title="remove"
                                                                        class="btn  text-danger border w-100 removebtn del-btn">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="desc"><i
                                            ...
                                            Description</label>
                                        <textarea name="description" id="step1" style="height: 10vh " class="form-control">{{$property->description}}</textarea>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="selectpicker form-control" name="commercial_building_name[]" multiple
                                            ...
                                            @foreach($comercial_building as $key => $comercial_building_val)
                                               <option value="{{$comercial_building_val}}"
                                               @if(!empty($property->commercialBuilding))
                                                 @foreach($property->commercialBuilding as $key => $commercialBuilding_value)
                                                     @if($commercialBuilding_value->name==$comercial_building_val)
                                                      selected
                                                     @endif
                                                 @endforeach
                                               @endif
                                               >{{$comercial_building_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="selectpicker form-control" name="building_feature_name[]" multiple
                                            ...
                                            @foreach($building_feature as $key => $building_feature_val)
                                               <option value="{{$building_feature_val}}"
                                               @if(!empty($property->buildingFeature))
                                                 @foreach($property->buildingFeature as $key => $buildingFeature_value)
                                                     @if($buildingFeature_value->name==$building_feature_val)
                                                      selected
                                                     @endif
                                                 @endforeach
                                               @endif
                                               >{{$building_feature_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="selectpicker form-control" name="unit_feature_name[]" multiple
                                            ...
                                            @foreach($unit_feature as $key => $unit_feature_val)
                                               <option value="{{$unit_feature_val}}"
                                               @if(!empty($property->unitFeature))
                                                 @foreach($property->unitFeature as $key => $unitFeature_value)
                                                     @if($unitFeature_value->name==$unit_feature_val)
                                                      selected
                                                     @endif
                                                 @endforeach
                                               @endif
                                               >{{$unit_feature_val}}</option> 
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="selectpicker form-control" name="near_by_name[]" multiple
                                            ...
                                            @foreach($near_by as $key => $near_by_val)
                                               <option value="{{$near_by_val}}"
                                               @if(!empty($property->nearBy))
                                                 @foreach($property->nearBy as $key => $nearBy_value)
                                                     @if($nearBy_value->name==$near_by_val)
                                                      selected
                                                     @endif
                                                 @endforeach
                                               @endif
                                    ...
                                    <div id="moretime" class="clonediv1">
                                        @if(!empty($property->openHouseDate))
                                           @foreach($property->openHouseDate as $key => $openHouseDate_value)
                                                <div class="producttime">
                                                    <div class="row">
                                                        <input type="hidden" name="open_house_id[]" value="{{$openHouseDate_value->id}}">
                                                        <div class="form-group col-md-3">
                                                            <label for=""><i class="fas fa-calendar"></i> Date</label>
                                                            <input type="date" class="form-control" name="date[]" value="{{$openHouseDate_value->date}}"
                                                                id="">
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <label for=""><i class="fas fa-clock"></i> Start Time</label>
                                                            <input type="time" class="form-control" name="start_time[]" value="{{$openHouseDate_value->start_time}}"
                                                                id="">
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <label for=""><i class="fas fa-clock"></i> End Time</label>
                                                            <input type="time" class="form-control" name="end_time[]" value="{{$openHouseDate_value->end_time}}"
                                                                id="">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <div class="row mt-32 ">
                                                                <div class="col-md-6 ">
                                                                    <button type="button" class="btn  w-100 border text-success add-btn1 "
                                                                        title="Add" >
                                                                        <i data-feather="plus"></i>
                                                                ...
                                                                <div class="col-md-6 text-center ">
                                                                    <button type="button" title="remove"
                                                                        class="btn  text-danger border w-100 removetime del-btn1">
                                                                        <i data-feather="minus"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                        ...
                                        @else
                                            <div class="producttime">
                                                <div class="row">
                                                    <input type="hidden" name="open_house_id[]" value="">
                                                    <div class="form-group col-md-3">
                                                        <label for=""><i class="fas fa-calendar"></i> Date</label>
...
@section('script')
    ...
    <script>
        ...
        $(document).on('click','.add-btn1',function(){
			var clone = $('.producttime').last().clone();
            $(clone).find("input").val("").end();
			$(clone).find("text").val("").end();
            $(clone).find("textarea").val("").end();
            //$(clone).append("<br><br><hr>");
			$('.clonediv1').append(clone);
			$('.del-btn1').show();
		});
		$(document).on('click','.del-btn1',function(){
			if($('.producttime').length>1){ 
